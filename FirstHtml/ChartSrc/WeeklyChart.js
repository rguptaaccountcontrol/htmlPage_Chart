async function DrawWeeklyChart(sym, jWklyArray)
    {
        ...
        options_Dly_Pr.title = 'Weekly Close Price (' + sym + ')';
        ...
        console.log(l);
        options_Sto.title = 'Weekly Stocatics (' + sym + ')';
        ...
        options_Mtum.title = 'Weekly Momentum (' + sym + ')';
